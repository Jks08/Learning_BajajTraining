...
class Emp:
    def __init__(self,eid,ename,esal=70000):    #self refers to current object. A name other than self can be given, 
...
if __name__=='__main__':
    obj1 = Emp(12345,'AB',60000)  #obj is a pointer to the actual object, which is Emp(..). First, allocation of memory happens, 
